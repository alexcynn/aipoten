...
export default function TrialAssessmentStartPage() {
        ...
        <div className="bg-white shadow rounded-lg">
          <div className="px-6 py-8">
            ...
            <div className="text-center mb-8">
              <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-brand-accent bg-opacity-20 text-brand-green mb-4">
                무료 체험
              </span>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <button
                    ...
                    style={formData.gender === 'MALE' ? {
                      borderColor: '#98C15E',
                      backgroundColor: 'rgba(152, 193, 94, 0.1)'
                    } : {}}
              ...
              <button
                ...
                className="w-full px-6 py-3 text-white rounded-md hover:opacity-90 transition-all font-medium text-lg shadow-md"
              >
                발달체크 시작하기
              </button>
            </form>

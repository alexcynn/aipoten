...
import { Brain, HandMetal, MessageCircle, Lightbulb, Users, Heart } from 'lucide-react'

export default function TrialAssessmentIntroPage() {
  const categories = [
    {
      id: 'GROSS_MOTOR',
      name: '대근육 운동',
    ...
    <div className="min-h-screen bg-neutral-light">
      ...
      <main className="max-w-6xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <span className="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium bg-aipoten-accent bg-opacity-20 text-aipoten-green mb-4">
            무료 체험
          </span>
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
          <Link
            ...
            className="w-full sm:w-auto px-8 py-4 bg-aipoten-green text-white rounded-lg hover:bg-aipoten-navy transition-colors font-bold text-lg shadow-lg text-center"
          >
            언어 발달 체험하기 →
          </Link>
          <Link
            href="/login?redirect=/parent/assessments/new"
            className="w-full sm:w-auto px-8 py-4 bg-white text-aipoten-green border-2 border-aipoten-green rounded-lg hover:bg-gray-50 transition-colors font-bold text-lg text-center"
          >
            로그인하고 전체 진단받기
          </Link>
        </div>
